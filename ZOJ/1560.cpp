/*
a simple line - line intersection problem
*/
...
int main()
{
    ...
    while(t--)
    {
        ...
        z1 = 360 - z1;
        z1 %= 360;
        double theta0 = z0*pi/180.0;
        double theta1 = z1*pi/180.0;

        point p0(x0, y0);
        point p1(x0 + 10, y0 + 10*tan(theta0));

        point p2(x1, y1);
        point p3(x1 + 10, y1 + 10*tan(theta1));

        point place;
        intersect(p0, p1, p2, p3, place);
